...
import com.vijay.v_canteen.admin.Selected_user;
...
public class Canteen_selected_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canteen_selected_user);

        name=findViewById(R.id.csu_name);
        id=findViewById(R.id.csu_id);
        phone=findViewById(R.id.csu_phone);
        email=findViewById(R.id.csu_email);
        dob=findViewById(R.id.csu_dob);
        gender=findViewById(R.id.csu_gender);

        remove=findViewById(R.id.csu_remove);
        block=findViewById(R.id.csu_block);
        unblock=findViewById(R.id.csu_unblock);
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(Canteen_selected_user.this)
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jobj.getString("status").equals("0")){
                        Toast.makeText(Canteen_selected_user.this, jobj.getString("message"), Toast.LENGTH_SHORT).show();
                        Intent i=new Intent(Canteen_selected_user.this, Canteen_manage_users.class);
                        startActivity(i);
                        finish();
                        removesharedp();
                    }
    ...
    public void onBackPressed() {
        removesharedp();
        Intent back=new Intent(Canteen_selected_user.this,Canteen_manage_users.class);
        startActivity(back);
        finish();
    }
