...
public class User_recycleradapter extends RecyclerView.Adapter<User_recycleradapter.RecyclerViewHolder> {
    ArrayList<User_getter> allusers;
    Context context;

    public User_recycleradapter(ArrayList<User_getter> allusers, Context context) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    SharedPreference.save("auid",allusers.get(pos).getU_id());
                        Intent next=new Intent(context, Selected_user.class);
